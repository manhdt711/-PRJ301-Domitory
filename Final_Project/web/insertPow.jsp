...
<html>
    ...
    <body style="font-family: Arial, Helvetica, sans-serif; overflow-x: hidden">
        ...
        <div style="width: 70%; height: 90%; margin-left: 20%; ">
            <form action="insPOW" method="post">
                <div class="optionchose" style="border: 1px solid; width: 300px;">
                    <div class="optionName" style="font-weight: bolder">
                        <ul>Mã Sinh Viên:<br><input type="text" name="masv" value="${Student.getStudentId()}" readonly>
                        </ul>
                        <ul>Mã Giường:<br><input type="text" name="bedid" value="${REGISTER.getRoomID()}" readonly></ul>
                        <ul>Loại: <select name="op"><option>Điện</option><option>Nước</option></select></ul>
                        <ul>Ngày:<br><input type="date" name="date" ></ul>
                        <ul>Số:<br><input type="text" name="count"></ul>
                    </div>

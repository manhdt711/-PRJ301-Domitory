 ...
 * @author ADMIN
 */
public class Doctor extends DBContext{
    String idD, idAc, fullname, profile, email, gender, address, phone, birthday, status;
    ...
    public Doctor(String idD, String fullname, String email) {
        this.idD = idD;
        this.fullname = fullname;
        this.email = email;
        connectDB();
